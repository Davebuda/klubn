...
namespace Infrastructure.Migrations
{
    ...
    [Migration("20260611210830_AddGdprConsent")]
    partial class AddGdprConsent
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("DJDiP.Domain.Models.AdmnModels.AuditLog", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("TEXT");
            ...
            modelBuilder.Entity("DJDiP.Domain.Models.ApplicationUser", b =>
                {
                    ...
                    b.Property<string>("MarketingPurpose")
                        .HasColumnType("TEXT");
            ...
            modelBuilder.Entity("DJDiP.Domain.Models.PromoCodeTicketType", b =>
                {
                    ...
                    b.HasKey("PromoCodeId", "TicketTypeId");

                    b.HasIndex("TicketTypeId");

                    b.ToTable("PromoCodeTicketTypes");
                });

            modelBuilder.Entity("DJDiP.Domain.Models.PromoRedemption", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("TEXT");
            ...
            modelBuilder.Entity("DJDiP.Domain.Models.PromotionCode", b =>
                {
                    ...
                    b.Property<bool>("UnlocksHiddenTypes")
                        .HasColumnType("INTEGER");
            ...
            modelBuilder.Entity("DJDiP.Domain.Models.PromoCodeTicketType", b =>
                {
                    b.HasOne("DJDiP.Domain.Models.PromotionCode", null)
                        .WithMany("TicketTypes")
                        .HasForeignKey("PromoCodeId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("DJDiP.Domain.Models.TicketType", null)
                        .WithMany()
                        .HasForeignKey("TicketTypeId")
                        .OnDelete(DeleteBehavior.Restrict)
                        .IsRequired();
