                    ...
                    <li key={s.id} className="flex items-center justify-between rounded-2xl border border-white/5 bg-black/30 px-4 py-2">
                      <div className="flex items-center gap-3">
                        ...
                        <div className="flex gap-1.5 ml-2">
                          {safeHttpUrl(s.spotifyUrl) && (
                            <a href={safeHttpUrl(s.spotifyUrl)} target="_blank" rel="noreferrer" title="Spotify"
                          ...
                          {safeHttpUrl(s.soundCloudUrl) && (
                            <a href={safeHttpUrl(s.soundCloudUrl)} target="_blank" rel="noreferrer" title="SoundCloud"
